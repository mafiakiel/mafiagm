...
cardCategories =
    [ { name = "Bürger"
      , cards =
            ...
            Der Fund wird angesagt."""
            , createCard Villagers GuardianAngel 
            """Der Engel kann jede Nacht einen Spieler vor einem Kill beschützen.
            Ausnahme:
            Der Engel beschützt nie vor dem Teufel."""
            , createCard Villagers Gardener 
            """Der Gärtner wird von dem Dedektiv als Mafiosi gefunden, während der Inspektor/Spion ihn Gärtner erkennt."""
            , createCard Villagers CrackWhore 
            """Als Nutte kann man jede Nacht einen Spieler vor dem Hängen am Tag beschützen.
            Es wird dann keiner gehängt.
            Stirbt man selbst verfällt auch der Schutz."""
            , createCard Villagers SecretAgent 
            ...
            , createCard Villagers Pathologist 
            ...
            , createCard Villagers WildHilda 
            """Die Wilde Hilde sucht sich am Anfang der Nacht einen Spieler aus und teilt dessen Schicksal.
            (Tod/Vampier/Mönch/Zombie usw.). Sie selbst kann in der Nacht allerdings nicht sterben (Sie ist ja nicht 'zu Hause')."""            
            , createCard Villagers Witch 
            ...
            , createCard Villagers CrimeSceneCleaner 
    ...
    , { name = "Mafia"
      , cards = 
        ...
        , createCard Mafia Spy
        """Der Spion kann nachts die Rolle eines Spielers erfahren."""
        , createCard Mafia Judge
        """Bei einem Unentschieden darf der Richter entscheiden, welcher Spieler (bzw. alle/keiner) gehängt werden soll."""
        , createCard Mafia Shoemaker
    ...
    , { name = "Kirche"
      , cards = 
        ...
        Vampire sterben.""" 
        , createCard Villagers Monk 
        """Als Mönch kennt man alle Mitmönche und den Papst."""
        , createCard Villagers MonkInLove
